...
struct PresenceView: View {
    ...
    @State private var isShowMoreClicked = false
    ...
    var body: some View {
        NavigationStack {
            ...
            .padding(.top, 14)
            .navigationDestination(isPresented: $isShowMoreClicked) {
                PresenceAllView().navigationTitle("Semua Presensi")
            }
            .navigationDestination(isPresented: $isDetailClicked) {
